...
export default function ChannelPartnerPremiumPage() {
  ...
  // ✅ UPDATED SUBMIT HANDLER - Different APIs for Channel vs Sales
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // ✅ Different API based on partner type
      const apiEndpoint = selectedPartnerType === "channel" 
        ? "/api/partner-application"        // Channel Partner → Old ERP (Lead)
        : "/api/sales-partner-application"; // Sales Partner → New ERP (Sales Partner)
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="relative">
                              ...
                              <Input 
                                ...
                                className={`${inputClassName} pl-10 ${gstError ? 'border-red-500 focus:ring-red-200' : ''}`}
                                maxLength={15}
                                disabled={submitting}
                              />
                            </div>
